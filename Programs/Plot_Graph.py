...
import os
os.chdir('C:\\Users\\hp\\Downloads\\AQI\\AQI')
...
if __name__ == "__main__":
    ...
    c = data_2015()
    d = data_2016()
    plt.plot(range(0, 365), a, label='2013')
    plt.plot(range(0, 364), b, label='2014')
    plt.plot(range(0, 365), c, label='2015')
    plt.plot(range(0, 121), d, label='2016')
    plt.xlabel('Day')
    plt.ylabel('PM 2.5')
